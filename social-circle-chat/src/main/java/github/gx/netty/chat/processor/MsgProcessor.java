package github.gx.netty.chat.processor;

import com.alibaba.fastjson.JSONObject;
import github.gx.netty.chat.protocol.IMDecoder;
import github.gx.netty.chat.protocol.IMEncoder;
import github.gx.netty.chat.protocol.IMMessage;
import github.gx.netty.chat.protocol.IMP;
...
public class MsgProcessor {
     ...
     * 从逻辑来讲，属于一个群对应一个实体类
     */
    //记录在线用户 TODO 对于不在线用户，怎么把这段时间的消息推送给他呢？？
    private static ChannelGroup onlineUsers = new DefaultChannelGroup(GlobalEventExecutor.INSTANCE);

    //定义一些扩展属性  AttributeKey 可以视为 键值对
    // 昵称
